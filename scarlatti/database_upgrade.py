...
from scarlatti.utils import translate_artist_name
from scarlatti.database_history import History
from scarlatti.define import App, Type, StorageType, SCARLATTI_DATA_PATH
...
#######################
    ...
    def __upgrade_31(self, db):
        ...
        """
        try:
            LOCAL_PATH = GLib.get_user_data_dir() + "/scarlatti"
    ...
    def __upgrade_46(self, db):
        ...
        """
        queue = SCARLATTI_DATA_PATH + "/queue.bin"
        try:
        ...
        def do_migration(dialog, label, progress):
            GLib.idle_add(
                label.set_text,
                _("Please wait while Scarlatti is updating albums"))
            ...
            for album_id in album_ids:
                ...
                lp_album_id = get_scarlatti_album_id(name, artists, None)
            ...
            GLib.idle_add(
                label.set_text,
                _("Please wait while Scarlatti is updating tracks"))
            for track_id in track_ids:
                ...
                lp_track_id = get_scarlatti_track_id(name, artists, album_name)
    ...
    def __upgrade_47(self, db):
        ...
        """
        from scarlatti.art import clean_all_cache
        clean_all_cache()
