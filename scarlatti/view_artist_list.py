...
from scarlatti.define import ViewType, MARGIN, MARGIN_SMALL, App
from scarlatti.utils import set_cursor_type
from scarlatti.widgets_banner_artist import ArtistBannerWidget
from scarlatti.widgets_album import AlbumWidget
from scarlatti.objects_album import Album
from scarlatti.view_lazyloading import LazyLoadingView
...
#######################
    ...
    def __on_populated(self, view):
        ...
        from scarlatti.view_albums_line import AlbumsArtistAppearsOnLineView
