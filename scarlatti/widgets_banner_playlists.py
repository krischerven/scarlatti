...
from scarlatti.define import App, ArtSize, MARGIN, ViewType
from scarlatti.define import SelectionListMask
...
#######################
    ...
    def __on_menu_button_clicked(self, button):
        """
            ...
            @param button as Gtk.Button
        """
        from scarlatti.menu_selectionlist import SelectionListMenu
