...
from scarlatti.define import App, ScanType, Type, LovedFlags
...
#######################
    ...
    def __on_settings_activate(self, action, value):
        ...
        """
        def do():
            from scarlatti.dialog_settings import SettingsDialog
    ...
    def __on_about_activate(self, action, value):
        ...
        def get_instance(children, instance):
            ...
            return None
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/AboutDialog.ui")
    ...
    def __on_shortcuts_activate(self, action, value):
        ...
        """
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/Shortcuts.ui")
        ...
        if string == "play_pause":
            ...
            if track.id is not None and track.id >= 0:
                ...
                if loved & LovedFlags.LOVED:
                    ...
                    heart = "♡"
                App().notify.send("Scarlatti", "%s - %s: %s" %
                                  (", ".join(track.artists),
                                   track.name,
                                   heart))
