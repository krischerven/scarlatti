...
from scarlatti.localized import LocalizedCollation
from scarlatti.shown import ShownPlaylists
from scarlatti.utils import emit_signal, get_default_storage_type
from scarlatti.utils_file import get_mtime
from scarlatti.logger import Logger
from scarlatti.database_upgrade import DatabasePlaylistsUpgrade
...
class Playlists(GObject.GObject):
    """
        Playlists manager
    """
    __LOCAL_PATH = GLib.get_user_data_dir() + "/scarlatti"
