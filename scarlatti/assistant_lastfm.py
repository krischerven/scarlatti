...
from scarlatti.assistant import Assistant
...
you need to allow <b>Scarlatti</b>.""") % name,
              "uri_label": "",
              "uri": None,
...
Then, allow Scarlatti.""") % name,
            ...
            },
            {
              ...
              "markup": _("""
<b>Click "Finish"</b> once Scarlatti has been allowed."""),
              "uri_label": "",
              "uri": None,
              "right_button_label": _("Back"),
              "right_button_style": "",
