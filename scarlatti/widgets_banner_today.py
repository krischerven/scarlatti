...
from scarlatti.define import App, ArtSize, MARGIN, ViewType, StorageType
from scarlatti.define import ArtBehaviour, SCARLATTI_DATA_PATH
from scarlatti.widgets_banner import BannerWidget
from scarlatti.widgets_cover import BrowsableCoverWidget
from scarlatti.objects_album import Album
from scarlatti.logger import Logger
from scarlatti.utils import get_default_storage_type, popup_widget
...
class TodayBannerWidget(BannerWidget, SignalsHelper):
    ...
    def get_today_album():
        ...
        try:
            (date, album_id) = load(
                open(SCARLATTI_DATA_PATH + "/today.bin", "rb"))
        ...
        try:
            if date != current_date:
                ...
                dump((current_date, album_id),
                     open(SCARLATTI_DATA_PATH + "/today.bin", "wb"))
...
#######################
    ...
    def __on_menu_button_clicked(self, button):
        """
            ...
            @param button as Gtk.Button
        """
        from scarlatti.menu_suggestions import SuggestionsMenu
