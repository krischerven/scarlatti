...
from scarlatti.define import App, ViewType, MARGIN, ScanUpdate
from scarlatti.view_tracks_album import AlbumTracksView
from scarlatti.widgets_banner_album import AlbumBannerWidget
    ...
    def __on_tracks_populated(self, view):
        ...
        if self.__tracks_view.is_populated:
            ...
            if self.view_type & ViewType.OVERLAY:
                from scarlatti.view_albums_line import AlbumsArtistLineView
