...
from scarlatti.utils import get_human_duration, popup_widget
from scarlatti.utils_album import tracks_to_albums
from scarlatti.define import App, ArtSize, ViewType
...
class PlaylistBannerWidget(BannerWidget, SignalsHelper):
    ...
    def __init__(self, playlist_id, view):
        ...
        builder.add_from_resource(
            "/org/scarlatti/Scarlatti/PlaylistBannerWidget.ui")
