...
from scarlatti.define import ViewType, App, MARGIN_SMALL, Type
from scarlatti.helper_adaptive import AdaptiveHelper
from scarlatti.helper_signals import SignalsHelper, signals_map
from scarlatti.helper_filtering import FilteringHelper
...
class View(Gtk.Grid, AdaptiveHelper, FilteringHelper, SignalsHelper):
    ...
    def show_placeholder(self, show, new_text=None):
        ...
        if show:
            ...
            from scarlatti.widgets_placeholder import Placeholder
