...
from scarlatti.define import App, ViewType, Type, LovedFlags
...
#######################
    def _append_to_playback(self, action, variant):
        """
            ...
            @param GLib.Variant
        """
        from scarlatti.utils_artist import add_artist_to_playback
...
#######################
    ...
    def __on_play_action_activate(self, action, variant):
        """
            ...
            @param GLib.Variant
        """
        from scarlatti.utils_artist import play_artists
