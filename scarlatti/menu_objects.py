...
from scarlatti.define import StorageType, MARGIN_SMALL, App
from scarlatti.define import ViewType, Type
from scarlatti.menu_playlists import PlaylistsMenu
from scarlatti.menu_actions import ActionsMenu
from scarlatti.menu_playback import TrackPlaybackMenu, AlbumPlaybackMenu
from scarlatti.menu_sync import SyncAlbumsMenu
...
class TrackMenuExt(Gtk.Grid):
    ...
    def __init__(self, track):
        ...
        if track.is_web:
            from scarlatti.helper_web import WebHelper
