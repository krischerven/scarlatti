...
from scarlatti.widgets_albums_decade import AlbumsDecadeWidget
from scarlatti.define import App, Type, ViewType, OrderBy
...
#######################
    ...
    def _get_menu_widget(self, child):
        ...
        from scarlatti.menu_decade import DecadeMenu
