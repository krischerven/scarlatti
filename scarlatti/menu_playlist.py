...
from scarlatti.define import App, MARGIN_SMALL, Type
...
class PlaylistMenu(Gio.Menu):
    ...
    def __init__(self, playlist_id, view_type, header=False):
        ...
        from scarlatti.menu_playback import PlaylistPlaybackMenu
        ...
        from scarlatti.menu_sync import SyncPlaylistsMenu
