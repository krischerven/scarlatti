...
class SpotifyWebHelper:
    ...
    def scarlatti_album_payload(self, payload):
        ...
        scarlatti_payload["uri"] = "sp:%s" % payload["id"]
        scarlatti_payload["name"] = payload["name"]
        artists = []
        for artist in payload["artists"]:
            artists.append(artist["name"])
        scarlatti_payload["artists"] = ";".join(artists)
        scarlatti_payload["track-count"] = payload["total_tracks"]
        scarlatti_payload["date"] = "%sT00:00:00" % payload["release_date"]
        scarlatti_payload["artwork-uri"] = payload["images"][0]["url"]
    ...
    def scarlatti_track_payload(self, payload):
        ...
        scarlatti_payload["tracknumber"] = payload["track_number"]
        scarlatti_payload["duration"] = payload["duration_ms"]
        return scarlatti_payload
