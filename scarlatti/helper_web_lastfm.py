...
from scarlatti.define import App, LASTFM_API_KEY
...
class LastFMWebHelper:
    ...
    def get_scarlatti_payload(self, mbid, cancellable):
        """
        ...
        try:
            ...
            Logger.error(
                "LastFMWebHelper::get_scarlatti_payload(): %s", uri)
        return None
    ...
    def scarlatti_album_payload(self, payload):
        ...
        scarlatti_payload["uri"] = ""
        scarlatti_payload["artists"] = payload["artist"]
        scarlatti_payload["track-count"] = len(payload["tracks"])
        scarlatti_payload["date"] = None
        try:
            artwork_uri = payload["image"][-1]["#text"]
        except:
            artwork_uri = None
        scarlatti_payload["artwork-uri"] = artwork_uri
        return scarlatti_payload

    def scarlatti_track_payload(self, payload, tracknumber):
        """
            Convert payload to Scarlatti one
            @param payload as {}
        ...
        scarlatti_payload["tracknumber"] = tracknumber
