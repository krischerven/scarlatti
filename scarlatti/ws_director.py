...
from scarlatti.define import NetworkAccessACL, App, Type
from scarlatti.ws_token import TokenWebService
...
#######################
    def __handle_collection(self, acl):
        ...
        if start and self.__collection_ws is None:
            from scarlatti.ws_collection import CollectionWebService
    ...
    def __handle_lastfm(self, acl):
        ...
        if start and self.__lastfm_ws is None:
            from scarlatti.ws_lastfm import LastFMWebService
    ...
    def __handle_listenbrainz(self, acl):
        ...
        if start and self.__listenbrainz_ws is None:
            from scarlatti.ws_listenbrainz import ListenBrainzWebService
