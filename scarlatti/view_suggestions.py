...
from scarlatti.utils import get_network_available
from scarlatti.define import ViewType, StorageType, Size, App
from scarlatti.view_albums_line import AlbumsPopularsLineView
from scarlatti.view_albums_line import AlbumsRandomGenresLineView
from scarlatti.view_artists_line import ArtistsRandomLineView
from scarlatti.widgets_banner_today import TodayBannerWidget
from scarlatti.helper_signals import signals_map
...
#######################
    def __add_web_views(self):
        """
            Add web views
        """
        from scarlatti.view_albums_line import AlbumsStorageTypeLineView
    ...
    def __welcome_screen(self):
        ...
        """
        label = Gtk.Label.new(_("Welcome to Scarlatti"))
        ...
        image = Gtk.Image.new_from_icon_name("org.scarlatti.Scarlatti",
