...
from scarlatti.pop_devices import DevicesPopover
from scarlatti.define import App, Repeat, Type
from scarlatti.utils import popup_widget, emit_signal, get_network_available
from scarlatti.progressbar import ButtonProgressBar
...
class ToolbarEnd(Gtk.Bin):
    ...
    def __init__(self, window):
        ...
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/ToolbarEnd.ui")
...
#######################
    ...
    def _on_settings_button_toggled(self, button):
        """
           ...
           @param button as Gtk.ToggleButton
        """
        from scarlatti.menu_application import ApplicationMenu
        if button.get_active():
