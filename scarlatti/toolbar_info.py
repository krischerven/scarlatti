...
from scarlatti.utils import set_cursor_type, popup_widget
...
from scarlatti.define import App, ArtBehaviour, StorageType, MARGIN_SMALL
from scarlatti.define import ViewType
from scarlatti.helper_gestures import GesturesHelper
...
#######################
    def __popup_menu(self):
        ...
        if track.id is not None and track.id >= 0:
            from scarlatti.menu_objects import TrackMenu, TrackMenuExt
