...
from scarlatti.define import App, ArtSize, Type, ViewType
from scarlatti.define import ArtBehaviour, MARGIN_MEDIUM, MARGIN, MARGIN_SMALL
from scarlatti.widgets_rating import RatingWidget
from scarlatti.widgets_loved import LovedWidget
from scarlatti.widgets_label import LabelWidget
from scarlatti.widgets_cover import EditCoverWidget, CoverWidget
from scarlatti.widgets_banner import BannerWidget
from scarlatti.utils import get_human_duration, on_query_tooltip
from scarlatti.utils import popup_widget, emit_signal
...
#######################
    ...
    def __on_menu_button_clicked(self, button):
        ...
        from scarlatti.menu_objects import AlbumMenu
        from scarlatti.menu_artwork import AlbumArtworkMenu
