...
from scarlatti.define import App, ArtSize, ArtBehaviour
from scarlatti.define import MARGIN_BIG
...
from scarlatti.container import Container
...
class FullScreen(Gtk.Window, SignalsHelper):
    ...
    def delayed_init(self):
        ...
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/FullScreen.ui")
