...
from scarlatti.utils import set_cursor_type, on_query_tooltip, popup_widget
from scarlatti.utils_artist import add_artist_to_playback, play_artists
from scarlatti.define import App, ArtSize, ArtBehaviour, ViewType
from scarlatti.define import MARGIN_MEDIUM, MARGIN, MARGIN_SMALL
from scarlatti.widgets_banner import BannerWidget
...
class ArtistBannerWidget(BannerWidget, SignalsHelper):
    ...
    def __init__(self, genre_ids, artist_ids, storage_type, view_type):
        ...
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/ArtistBannerWidget.ui")
...
#######################
    ...
    def _on_label_button_release(self, eventbox, event):
        ...
        if len(self.__artist_ids) == 1:
            from scarlatti.pop_information import InformationPopover
    ...
    def _on_menu_button_clicked(self, button):
        ...
        from scarlatti.menu_artist import ArtistMenu
        from scarlatti.menu_similars import SimilarsMenu
        from scarlatti.menu_artwork import ArtistArtworkMenu
    ...
    def _on_badge_button_release(self, eventbox, event):
        ...
        menu = Gio.Menu()
        if App().window.folded:
            from scarlatti.menu_header import ArtistMenuHeader
