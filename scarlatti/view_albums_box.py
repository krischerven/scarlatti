...
from scarlatti.widgets_album_simple import AlbumSimpleWidget
from scarlatti.define import App, Type, ViewType, ScanUpdate, StorageType
from scarlatti.objects_album import Album
from scarlatti.utils import get_icon_name, get_network_available, popup_widget
from scarlatti.utils import get_title_for_genres_artists
from scarlatti.utils import remove_static
from scarlatti.utils_file import get_youtube_dl
from scarlatti.utils_album import get_album_ids_for
...
#######################
    ...
    def __on_banner_show_menu(self, banner, button):
        ...
        """
        from scarlatti.menu_objects import AlbumsMenu
        from scarlatti.widgets_menu import MenuBuilder
        albums = []
        for child in self._box.get_children():
            if child.data.storage_type & StorageType.COLLECTION:
