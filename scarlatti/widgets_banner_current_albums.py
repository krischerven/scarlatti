...
from scarlatti.define import App, ArtSize, ViewType, Size
from scarlatti.define import MARGIN
from scarlatti.widgets_banner import BannerWidget
from scarlatti.utils import emit_signal, popup_widget, get_human_duration
...
#######################
    ...
    def __on_menu_button_clicked(self, button):
        ...
        from scarlatti.menu_current_albums import CurrentAlbumsMenu
