...
from scarlatti.sync_mtp import MtpSync
...
class DeviceWidget(Gtk.ListBoxRow):
    ...
    def __init__(self, name, uri, icon=None):
        ...
        self.__builder.add_from_resource("/org/scarlatti/Scarlatti/DeviceWidget.ui")
...
#######################
    ...
    def _on_content_albums_clicked(self, button):
        ...
        if index is not None:
            ...
            App().notify.send("Scarlatti", _("No synchronized albums"))
    ...
    def _on_content_playlists_clicked(self, button):
        ...
        if index is not None:
            ...
            App().notify.send("Scarlatti", _("No synchronized playlists"))
