...
from scarlatti.define import App, Type, ViewType, StorageType
from scarlatti.utils import emit_signal, get_default_storage_type
...
class ViewsContainer:
    ...
    def show_menu(self, widget):
        ...
        from scarlatti.view_menu import MenuView
    ...
    def show_view(self, item_ids, data=None, storage_type=None):
        ...
        if item_ids:
            if item_ids[0] in [Type.POPULARS,
                ...
                from scarlatti.view_equalizer import EqualizerView
                view = EqualizerView()
    ...
    def get_view_current(self):
        """
            ...
            @return View
        """
        from scarlatti.view_current_albums import CurrentAlbumsView
    ...
    def get_view_search(self, search=""):
        """
            ...
            @return SearchView
        """
        from scarlatti.view_search import SearchView
        view = None
...
##############
    def _get_view_playlists(self, playlist_id=None):
        ...
        if playlist_id is None:
            from scarlatti.view_playlists_manager import PlaylistsManagerView
            view = PlaylistsManagerView(view_type)
        else:
            from scarlatti.view_playlists import PlaylistsView
    ...
    def _get_view_device_playlists(self, index):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_playlists_manager import PlaylistsManagerDeviceView
    ...
    def _get_view_lyrics(self):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_lyrics import LyricsView
    ...
    def _get_view_artists_rounded(self, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_artists_rounded import RoundedArtistsViewWithBanner
    ...
    def _get_view_artists(self, genre_ids, artist_ids, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_artist_list import ArtistViewList
    ...
    def _get_view_suggestions(self, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_suggestions import SuggestionsView
    ...
    def _get_view_albums_decades(self, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_decades_box import DecadesBoxView
    ...
    def _get_view_album(self, album, storage_type):
        ...
        from scarlatti.view_album import AlbumView
    ...
    def _get_view_genres(self, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_genres_box import GenresBoxView
    ...
    def _get_view_albums_years(self, years, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_albums_box import AlbumsForYearsBoxView
    ...
    def _get_view_albums(self, genre_ids, artist_ids, storage_type):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_albums_box import AlbumsForGenresBoxView
    ...
    def _get_view_device_albums(self, index):
        ...
        """
        view_type = ViewType.SCROLLED
        from scarlatti.view_albums_box import AlbumsDeviceBoxView
    ...
    def _get_view_info(self):
        ...
        """
        from scarlatti.view_information_stack import InformationViewStack
