...
from scarlatti.define import App, ScanType, ArtSize
from scarlatti.container import Container
from scarlatti.toolbar import Toolbar
...
class Window(Handy.ApplicationWindow, SignalsHelper):
    ...
    def __init__(self):
        ...
        Handy.ApplicationWindow.__init__(self,
                                         application=App(),
                                         title="Scarlatti",
                                         icon_name="org.scarlatti.Scarlatti")
    ...
    def show_miniplayer(self, show, reveal=False):
        ...
        if show and self.__miniplayer is None:
            from scarlatti.miniplayer import MiniPlayer
