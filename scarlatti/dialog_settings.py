...
from scarlatti.define import App, NetworkAccessACL, ScanType
...
class SettingsDialog:
    """
        Dialog showing scarlatti settings
    """
    ...
    def __init__(self):
        ...
        self.__locked = []
        builder = Gtk.Builder()
        builder.add_from_resource("/org/scarlatti/Scarlatti/SettingsDialog.ui")
...
#######################
    ...
    def _on_connect_button_clicked(self, button):
        ...
        if button.get_tooltip_text():
            ...
            if name == "GOOGLE":
                from scarlatti.assistant_google import GoogleAssistant
                assistant = GoogleAssistant()
            elif name in ["LASTFM", "LIBREFM"]:
                from scarlatti.assistant_lastfm import LastfmAssistant
                assistant = LastfmAssistant(name)
            else:
                from scarlatti.assistant_musicbrainz import MusicbrainzAssistant
