...
class ButtonsPlayerWidget(Gtk.Box, SignalsHelper):
    ...
    def __init__(self, styles=[]):
        ...
        self.pack_start(self.__prev_button, False, True, 0)
        self.pack_start(self.__play_button, False, True, 0)
        self.pack_start(self.__next_button, False, True, 0)
        ...
        if styles:
            ...
            self.__prev_button.set_hexpand(True)
            self.__play_button.set_hexpand(True)
            self.__next_button.set_hexpand(True)
        else:
